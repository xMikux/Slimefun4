...
public class GrindStone extends MultiBlockMachine {
    ...
    public GrindStone(ItemGroup itemGroup, SlimefunItemStack item) {
        super(itemGroup, item, new ItemStack[] { null, null, null, null, new ItemStack(Material.OAK_FENCE), null, null, new CustomItemStack(Material.DISPENSER, "發射器（朝上）"), null }, BlockFace.SELF);
    }
