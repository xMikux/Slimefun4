...
public class Compressor extends MultiBlockMachine {
    ...
    public Compressor(ItemGroup category, SlimefunItemStack item) {
        super(category, item, new ItemStack[] { null, null, null, null, new ItemStack(Material.NETHER_BRICK_FENCE), null, new ItemStack(Material.PISTON), new CustomItemStack(Material.DISPENSER, "發射器 (朝上)"), new ItemStack(Material.PISTON) }, BlockFace.SELF);
    }
