...
public class HologramProjector extends SlimefunItem implements HologramOwner {
    ...
    private static void openEditor(Player p, Block projector) {
        ...
        menu.addItem(0, new CustomItem(Material.NAME_TAG, "&7文本 &e(點擊編輯)", "", "&r" + ChatColors.color(BlockStorage.getLocationInfo(projector.getLocation(), "text"))));
        ...
        menu.addItem(1, new CustomItem(Material.CLOCK, "&7偏移量: &e" + NumberUtils.roundDecimalNumber(Double.valueOf(BlockStorage.getLocationInfo(projector.getLocation(), OFFSET_PARAMETER)) + 1.0D), "", "&r左鍵: &7+0.1", "&r右鍵: &7-0.1"));
